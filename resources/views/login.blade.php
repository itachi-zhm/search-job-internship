...
<body>
    ...
    <section class="main-banner" style="background:#6fa1df url(img/login.jpg) no-repeat">
        <div class="container">
            <div class="caption">
                ...
                <fieldset>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <a href="/entreprise/login" class="btn btn-primary">ENTREPRISE</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <a href="/user/login" class="btn btn-primary">EMPLOYE</a>
                                </div>
                            </div>
                        </div>
                    </div>
